...
function Cart() {
            ...
            <div className=" bg-amber-100 rounded-3xl w-100 h-100 flex flex-col gap-4 m-10">
              ...
              <div className="flex flex-col justify-center items-center">
                <button
                  ...
                  className="bg-amber-300 text-amber-700 font-bold rounded-full p-5 hover:bg-amber-300/90 hover:scale-105 text-2xl"
                >
                  Start Brewing
                </button>
              </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-8xl  bg-white">
